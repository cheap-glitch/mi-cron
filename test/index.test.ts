...
describe('parseCron.nextDate', () => {
	...
	it('gives the correct next scheduled date', () => {
		...
		expect(parseCron.nextDate('* * * * *', new Date('01 Jan 2020 00:00:00 GMT'))?.toUTCString()).toBe(
			new Date('01 Jan 2020 00:01:00 GMT').toUTCString()
		);
		expect(parseCron.nextDate('0 * * * *', new Date('01 Jan 2020 00:00:00 GMT'))?.toUTCString()).toBe(
			new Date('01 Jan 2020 01:00:00 GMT').toUTCString()
		);
		expect(parseCron.nextDate('*/5 * * * *', new Date('01 Jan 2020 00:01:00 GMT'))?.toUTCString()).toBe(
			new Date('01 Jan 2020 00:05:00 GMT').toUTCString()
		);
		expect(parseCron.nextDate('* * 5-24 * *', new Date('12 Jan 2020 00:00:00 GMT'))?.toUTCString()).toBe(
			new Date('12 Jan 2020 00:01:00 GMT').toUTCString()
		);

		// Examples from <https://crontab.guru>
		expect(parseCron.nextDate('5 0 * 8 *', new Date('25 Sep 2020 12:00:00 GMT'))?.toUTCString()).toBe(
			new Date('01 Aug 2021 00:05:00 GMT').toUTCString()
		);
		expect(parseCron.nextDate('15 14 1 * *', new Date('25 Sep 2020 12:00:00 GMT'))?.toUTCString()).toBe(
			new Date('01 Oct 2020 14:15:00 GMT').toUTCString()
		);
		expect(parseCron.nextDate('23 0-20/2 * * *', new Date('25 Sep 2020 12:00:00 GMT'))?.toUTCString()).toBe(
			new Date('25 Sep 2020 12:23:00 GMT').toUTCString()
		);
		expect(parseCron.nextDate('0 0,12 1 */2 *', new Date('25 Sep 2020 12:00:00 GMT'))?.toUTCString()).toBe(
			new Date('01 Nov 2020 00:00:00 GMT').toUTCString()
		);
		expect(parseCron.nextDate('0 4 8-14 * *', new Date('25 Sep 2020 12:00:00 GMT'))?.toUTCString()).toBe(
			new Date('08 Oct 2020 04:00:00 GMT').toUTCString()
		);
		expect(parseCron.nextDate('@weekly', new Date('25 Sep 2020 12:00:00 GMT'))?.toUTCString()).toBe(
			new Date('27 Sep 2020 00:00:00 GMT').toUTCString()
		);
	}); // }}}
	...
	it('supports week days', () => {
		...
		expect(parseCron.nextDate('* * * * mon', new Date('01 Jan 2020 00:00:00 GMT'))?.toUTCString()).toBe(
			new Date('06 Jan 2020 00:00:00 GMT').toUTCString()
		);
		expect(parseCron.nextDate('* * 1 1 sun', new Date('01 Jan 2020 00:00:00 GMT'))?.toUTCString()).toBe(
			new Date('01 Jan 2023 00:00:00 GMT').toUTCString()
		);
		expect(parseCron.nextDate('5 4 * * sun', new Date('25 Sep 2020 12:00:00 GMT'))?.toUTCString()).toBe(
			new Date('27 Sep 2020 04:05:00 GMT').toUTCString()
		);
		expect(parseCron.nextDate('0 22 * * 1-5', new Date('25 Sep 2020 12:00:00 GMT'))?.toUTCString()).toBe(
			new Date('25 Sep 2020 22:00:00 GMT').toUTCString()
		);
		expect(parseCron.nextDate('0 0 1,15 * 3', new Date('25 Sep 2020 12:00:00 GMT'))?.toUTCString()).toBe(
			new Date('01 Sep 2021 00:00:00 GMT').toUTCString()
		);
	}); // }}}
	...
	it('works with cron schedule objects', () => {
		...
		expect(
			parseCron
				.nextDate(
					...
					new Date('25 Sep 2020 12:00:00 GMT')
				)
				?.toUTCString()
		).toBe(new Date('01 Aug 2021 00:05:00 GMT').toUTCString());
		...
		expect(
			parseCron
				...
				?.toUTCString()
		).toBe(new Date('01 Oct 2020 14:15:00 GMT').toUTCString());
		...
		expect(
			parseCron
				...
				?.toUTCString()
		).toBe(new Date('25 Sep 2020 12:23:00 GMT').toUTCString());
	}); // }}}
});
